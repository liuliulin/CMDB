# -*- coding: utf-8 -*-
# Generated by Django 1.11.14 on 2018-07-31 00:21
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('monitor', '0002_auto_20180727_1505'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('has_sub_service', models.BooleanField(default=False, help_text='服务有独立的子服务 ,选择这个,如网卡服务')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_type', models.CharField(choices=[('int', 'int'), ('float', 'float'), ('str', 'string')], default='float', max_length=32, verbose_name='指标数据类型')),
                ('memo', models.CharField(blank=True, max_length=128, null=True, verbose_name='备注')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AlterField(
            model_name='myuser',
            name='group',
            field=models.ManyToManyField(blank=True, to='monitor.MyGroup', verbose_name='部门或组'),
        ),
        migrations.AlterField(
            model_name='myuser',
            name='name',
